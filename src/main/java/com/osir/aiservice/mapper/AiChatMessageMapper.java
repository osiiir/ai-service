...
public interface AiChatMessageMapper {
     ...
     */
    void insertBatch(@Param("aiChatMessageList") List<AiChatMessage> aiChatMessageList);
    ...
    List<AiChatMessage> selectListByConversationId(@Param("conversationId") String conversationId);
