...
import com.osir.aiservice.pojo.entity.SimulatorChatMessage;
...
public interface SimulatorChatMessageMapper {
     ...
     */
    void insertBatch(@Param("simulatorChatMessageList") List<SimulatorChatMessage> simulatorChatMessageList);
    ...
    List<SimulatorChatMessage> selectListByConversationId(@Param("conversationId") String conversationId);
